...
<p class="center">
![Главное окно программы](/images/mainwindow.png){html: width=50%, latex: width=5cm}
</p>
...
![Окно "G-код программа"](images/g-codeprogram.png){html: width=30%, latex: width=5cm}
...
![Окно "Визуализатор"](/images/visualizer.png)
...
![Окно "Консоль"](/images/console.png)
...
![Панель "Состояние"](/images/status.png)
...
![Панель "Управление"](/images/control.png)
...
![Панель "Система координат"](/images/coordinatesystem.png)
...
![Панель "Шпиндель"](/images/spindle.png)
...
![Панель "Перемещение"](/images/jogging.png)
...
![Панель "Коррекция"](/images/overriding.png)
...
![Панель "Карта высот"](/images/heightmap.png)
...
Более подробная информация об использовании карты высот приведена в п. [3.7 "Создание карты высот"](#sozdanie-karty-vysot) данного руководства.
...
![Панель "Пользовательские команды"](/images/usercommands.png)
...
Подробнее об использовании языка программирования JavaScript в программе читайте в п. [5 "Разработка расширений"](#razrabotka-rasshireniy) данного руководства
